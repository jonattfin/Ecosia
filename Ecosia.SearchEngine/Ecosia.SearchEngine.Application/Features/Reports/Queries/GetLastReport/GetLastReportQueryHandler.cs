...
public class GetLastReportQueryHandler : IRequestHandler<GetLastReportQuery, ReportDetailVm>
{
    ...
    public async Task<ReportDetailVm> Handle(GetLastReportQuery query, CancellationToken cancellationToken)
    {
        var report = await _reportRepository.GetLast();
